...
export function createWebScraper({ lanternPath = null } = {}) {
  ...
  async function getCookiesViaLantern(domain) {
    const defaultLantern = fs.existsSync(path.resolve("lib/skills/leo-lantern/scripts/cli/index.mjs"))
      ? path.resolve("lib/skills/leo-lantern/scripts/cli/index.mjs")
      : fs.existsSync(path.resolve("lib/skills/leo-lantern/scripts/index.mjs"))
      ? path.resolve("lib/skills/leo-lantern/scripts/index.mjs")
      : path.resolve("clis/leo-lantern/index.mjs");
  ...
  async function getNetscapeCookiesViaLantern(domain, outPath = null) {
    const defaultLantern = fs.existsSync(path.resolve("lib/skills/leo-lantern/scripts/cli/index.mjs"))
      ? path.resolve("lib/skills/leo-lantern/scripts/cli/index.mjs")
      : fs.existsSync(path.resolve("lib/skills/leo-lantern/scripts/index.mjs"))
      ? path.resolve("lib/skills/leo-lantern/scripts/index.mjs")
    ...
    const args = [cliPath, "cookies", "--domain", domain, "--format", "txt"];
    if (outPath) {
