...
import { LanternMcpServer, MCP_TOOLS } from "../scripts/mcp/lib/mcp-server.mjs";
import { LanternServer } from "../scripts/mcp/lib/server.mjs";
import http from "node:http";
import { LanternServer as CliLanternServer } from "../scripts/cli/lib/server.mjs";
import {
  COMMAND_TYPES as CliCommandTypes,
  DEFAULT_BRIDGE_PORT as CliDefaultPort,
} from "../scripts/cli/lib/protocol.mjs";
import { COMMAND_TYPES, DEFAULT_BRIDGE_PORT } from "../scripts/mcp/lib/protocol.mjs";
...
test("MCP and CLI provide compatible LanternServer implementations", () => {
  assert.equal(typeof LanternServer, "function");
  assert.equal(LanternServer.name, CliLanternServer.name);
