...
// 常用微服务到服务云端口与库名的默认映射字典
const SERVICE_DB_MAPPING = {
  'recorder': { port: '6763', database: 'utopia_scs_recorder', role: 'Slave', name: '智慧工地记录仪服务' },
  'utopia-scs-recorder': { port: '6763', database: 'utopia_scs_recorder', role: 'Slave', name: '智慧工地记录仪服务' },
  'saas': { port: '6763', database: 'scs_tenant_1', role: 'Slave', name: '智慧工地SaaS服务' },
  'utopia-scs-saas': { port: '6763', database: 'scs_tenant_1', role: 'Slave', name: '智慧工地SaaS服务' },
  'algo': { port: '6763', database: 'utopia_scs_algo', role: 'Slave', name: '智慧工地算法服务' },
  'utopia-scs-algo': { port: '6763', database: 'utopia_scs_algo', role: 'Slave', name: '智慧工地算法服务' },
  'platform': { port: '6384', database: 'iot_plat', role: 'Slave', name: 'IoT平台主库' },
  'iot-platform': { port: '6384', database: 'iot_plat', role: 'Slave', name: 'IoT平台主库' }
};
...
function printTokenGuide() {
  console.log(`
================================================================
🔑 如何获取服务云 cloud_console_token_egg（仅需 10 秒）：
================================================================
1. 在电脑 Chrome 打开已登录的服务云页面：
   👉 https://cloud.intra.ke.com/database/mysql/self-check

2. 按 F12（或右键点击页面任意处 ➔ 选择“检查”）打开开发者工具；

3. 切换到顶部的【Application】（中文版为【应用】）标签页；

4. 在左侧菜单展开【Storage (存储)】➔【Cookies】➔ 点击【https://cloud.intra.ke.com】；

5. 在右侧列表中找到名为【cloud_console_token_egg】的那一行；

6. 双击它的【Value（值）】（格式类似 2.0111a9beb...），Cmd+C 复制；

7. 复制后直接发给 AI，或者在终端运行：
