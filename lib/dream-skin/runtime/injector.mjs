...
export function loadRuntimeTheme({ themeJsonBytes, imageBytes, allowBuiltin = false }) {
  ...
  const theme = assertValidTheme(parsed, { allowBuiltin });
...
(() => {
  ...
  if (state) {
    state.version = "codex-plus:${engineName}:r${sig}";
  }
  return true;
})()
`;
