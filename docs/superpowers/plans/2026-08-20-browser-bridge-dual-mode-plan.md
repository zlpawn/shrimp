# Leo Lantern Dual Mode (MCP + CLI) Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Implement a standalone, zero-dependency Leo Lantern with dual MCP and CLI interfaces that attaches directly to user's real Chrome browser via Manifest V3 extension.

**Architecture:** A lightweight Node.js Bridge Server running on port 19527 managing an in-memory command queue. A stdio MCP Server for AI Agent tool calls, an ergonomic CLI client (`leo-lantern`), and an enhanced Chrome MV3 extension executing DOM, CDP, cookie, and tab actions.
...
### Task 1: Bridge Server Engine (`clis/leo-lantern/lib/server.mjs`)
...
### Task 2: CLI Client (`clis/leo-lantern/lib/cli.mjs` & `clis/leo-lantern/index.mjs`)
...
### Task 3: MCP Server (`mcps/leo-lantern/lib/mcp-server.mjs` & `mcps/leo-lantern/index.mjs`)
